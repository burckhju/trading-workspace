...
from app.features.model.api.proposal_approval_router import router as proposal_approval_router
...
from app.features.model.api.runtime_activation_router import router as runtime_activation_router
...
router.include_router(proposal_approval_router)
router.include_router(runtime_activation_router)
